...
function sungarden_create_video() {
	...
	add_action('restrict_manage_posts', 'sungarden_filter_video_by_taxonomy');
	function sungarden_filter_video_by_taxonomy() {
		global $typenow;
		$post_type = 'sungarden_video'; // change to your post type
		$taxonomy  = 'sungarden_video_cat'; // change to your taxonomy
	...
	add_filter('parse_query', 'sungarden_convert_id_to_term_video_in_query');
	function sungarden_convert_id_to_term_video_in_query($query) {
		global $pagenow;
		$post_type = 'sungarden_video'; // change to your post type
		$taxonomy  = 'sungarden_video_cat'; // change to your taxonomy
