            ...
            <div class="element-post-grid">
                <div class="row">
					<?php while ( $query->have_posts() ): $query->the_post(); ?>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-<?php echo esc_attr( 12 / $settings['column_number'] ); ?> item-col">
                            <div class="item-post">
                                ...
                                <a class="link-detail" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
