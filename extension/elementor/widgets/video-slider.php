...
class sungarden_widget_video_slider extends Widget_Base {
    ...
    public function get_name() {
        return 'sungarden-video-slider';
    }

    public function get_title() {
        return esc_html__( 'Video Slider', 'sungarden' );
    }
    ...
    protected function _register_controls() {
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'default'     => esc_html__( 'Video dự án', 'sungarden' ),
			    'label_block' => true
		    ]
	    );
	    ...
	    $this->add_control(
		    'text_link', [
			    ...
			    'type' => Controls_Manager::TEXT,
			    'default' => esc_html__( 'Xem thêm những video khác' , 'sungarden' ),
			    'label_block' => true,
		    ]
	    );
    ...
    ?>
        ...
        <div class="element-video-slider element-video-style owl-event-style">
...
Plugin::instance()->widgets_manager->register_widget_type( new sungarden_widget_video_slider );